-- KoreaLink: 전국 시/군/구 단위 지역 전체 시딩 (기존 8개 샘플 지역 포함, 중복 없이 추가)

alter table public.regions
  add constraint regions_sido_sigungu_key unique (sido, sigungu);
...
insert into public.regions (sido, sigungu) values
  ...
  ('충청북도','옥천군'),('충청북도','영동군'),('충청북도','증평군'),('충청북도','진천군'),
  ('충청북도','괴산군'),('충청북도','음성군'),('충청북도','단양군'),
  ...
  -- 경상북도 (22, 군위군은 2023년 대구광역시로 편입되어 대구 목록에 포함)
  ('경상북도','포항시'),('경상북도','경주시'),('경상북도','김천시'),('경상북도','안동시'),
  ('경상북도','구미시'),('경상북도','영주시'),('경상북도','영천시'),('경상북도','상주시'),
  ('경상북도','문경시'),('경상북도','경산시'),('경상북도','의성군'),('경상북도','청송군'),
  ...
  ('경상남도','의령군'),('경상남도','함안군'),('경상남도','창녕군'),('경상남도','고성군'),
  ('경상남도','남해군'),('경상남도','하동군'),('경상남도','산청군'),('경상남도','함양군'),
  ('경상남도','거창군'),('경상남도','합천군'),
