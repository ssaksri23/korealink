      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed text-slate-700">
        ...
        <section>
          ...
          <p>
            ...
            게시중단(임시조치)을 요청할 수 있습니다.
            <br />
            1) 회사는 요청을 받은 즉시 해당 게시물에 대해 임시조치(비공개 처리)를
            하고, 요청인과 게시자 양쪽에 조치 사실을 통지합니다.
            <br />
            2) 게시자는 이의가 있는 경우 소명자료를 제출할 수 있습니다.
            <br />
            3) 권리의 침해 여부를 판단하기 어렵거나 당사자 간 다툼이 예상되는
            경우, 재게시 여부와 무관하게 최대 30일간 임시조치를 유지할 수 있습니다.
          </p>
        </section>
      </div>
    </div>
