      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed text-slate-700">
        ...
        <section>
          ...
          <p>
            ...
            <br />
            2. 회사는 불법·유해 게시물을 방지하기 위해 게시 전후로 자동 또는 수동
            검토를 실시할 수 있습니다. 다만 게시물이 노출되었다는 사실이 해당
            게시물이나 거래 상대방의 신원·신뢰성·적법성을 회사가 보증하거나
            인증했음을 의미하지 않으며, 게시 이후에도 신고가 누적되거나 위반
            사실이 확인되면 즉시 비공개될 수 있습니다.
            <br />
        ...
        <section>
          ...
          <p>
            ...
            <br />
            3. 이용자는 입금 확인 전에는 주문 상세 화면에서 즉시 주문을 취소할 수
            있고, 입금 확인 후(상품이 이미 적용된 경우 포함)에는 같은 화면에서
            환불을 신청할 수 있습니다. 환불 신청은 회사의 확인 후 처리되며, 승인 시
            상품으로 인해 게시글에 적용된 효과(긴급 표시, 상단 고정 등)도 함께
            해제됩니다. 자세한 사항은 제7조의 연락처로 문의할 수 있습니다.
          </p>
        </section>
